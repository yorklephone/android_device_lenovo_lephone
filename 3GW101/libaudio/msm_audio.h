...
#define MSM_Q6_STREAM_VOLUME_BOOT  65   /* Eaddy 2010/02/01 : Set bootsound volume to 65 */
#define MSM_Q6_STREAM_VOLUME_NORMAL  40 /* Eaddy 2010/02/23 : Set stream volume back to 40 */
